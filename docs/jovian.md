...
*   **Carpo (The Specialist):** A pacifist gadgeteer who buffs her allies.
...
## Strategic Doctrine
The Jovian playstyle focuses on **Unit Quality** and **Synergy**. Unlike the Megacorp swarm, Jovian units are individually strong and become significantly more powerful when working together.

### Core Pillars:
1.  **Synergy:** Many units buff allies (Support, Rally) or rely on board presence.
2.  **Sustain:** High access to **Healing** and **Shields** (Guard) allows units to survive multiple turns and accrue value.
3.  **Versatility:** Access to a wide toolkit—Stuns (Control), Rushes (Aggro), and Card Draw (Value).

### Strengths:
*   High-value units that are hard to remove.
*   Strong board control tools (Stun, Disarm).
*   Excellent card draw and resource generation.

### Weaknesses:
*   Units are expensive; tempo loss can be fatal.
*   Vulnerable to "hard removal" (destroy effects) since they invest heavily in single units.

---

## Available Assets (Cards)

### Units (21 Heroes x 3 Tiers = 63 Cards)

#### Common (The Backbone)
*   **Himalia (The Shield)** (Cyber)
    *   T1 Citizen (3 Cost, 2/4): Vanilla
    *   T2 Heavy-weight (3 Cost, 3/5): **Guard.** 
    *   T3 The Shield (4 Cost, 4/6): **Guard.** 
...
*   **Leda (The Thief)** (Bio)
    ...
    *   T3 The Thief (3 Cost, 4/5): On Play: **Add 2 Tactics** to hand.
*   **Lysithea (The Hacker)** (Psi)
    *   T1 Script-Kiddie (3 Cost, 2/2): **Hack 1** (Random Enemy).
...
*   **Carpo (The Mechanic)** (Cyber)
    ...
    *   T3 The Mechanic (2 Cost, 3/5): **Breach**.
...
*   **Callisto (The Gang Queen)** (Bio)
    ...
    *   T3 The Gang Queen (3 Cost, 3/4): **Rage.** Summon 2 1/1 thugs.
*   **Taygete (The Heavy)** (Bio)
    *   T1 Loader (3 Cost, 2/4): Vanilla.
    *   T2 Gunner (3 Cost, 3/5): **Double Attack.**
    *   T3 The Heavy (3 Cost, 4/6): **Double Attack.**
*   **Cyllene (The Storm)** (Psi)
    *   T1 Static (4 Cost, 3/3): Spark 2.
    *   T2 Surge (4 Cost, 4/4): Spark 3.
    *   T3 The Storm (4 Cost, 5/5): Spark 3. OnPlay: Stun.

#### Rare (The Elite)
*   **Elara (The Biologist)** (Bio)
    *   T1 Researcher (3 Cost, 2/2): OnPlay: Draw 2. **Bio-Optimize 1** (OnPlay, give a unit you control +x/+x).
    *   T2 Geneticist (4 Cost, 2/3): OnPlay: Draw 2. **Bio-Optimize 2**.
    *   T3 The Biologist (5 Cost, 3/4): StartTurn: Bio-Optimize 1. OnPlay: Draw 3.
*   **Io (The Drone Master)** (Cyber)
    *   T1 Hobbyist (2 Cost, 1/4): Summon a 1/1 Drone.
...
*   **Ganymede (The Pugilist)** (Bio)
    ...
    *   T3 The Pugilist (4 Cost, 6/6): **Rush.** **Rage 1.** **Double Attack.**
...
| Name | Effect | Flavor |
| :--- | :--- | :--- |
| **Power Shot** | Deal 3 damage to enemy. | "Standard issue railgun." |
| **Nano-Repair** | Restore 2 Health. | "Just a scratch." |
| **Supply Drop** | Draw 2 cards. | "Reinforcements inbound." |
| **Reinforce** | Give unit +1/+1. | "Hold the line!" |
| **EMP Blast** | Stun an enemy. | "Lights out." |
| **Scramble** | Return unit to hand. | "Tactical retreat." |

---

## NOTES ON THE SISTERS
**Europa:** Psychic, quite powerful. Hears the Whispers, which worries her a lot. Ganymede, who she's closest to, always says she worries too much. Diplomatic and motherly, has a bit of friction with some sisters cos she tries to look after them. Not a matriarch. Concerned at 'what's coming'. Effectively immortal when she's summoned all her powers and is going all out - or at least, nobody has figured out how to kill her. Slow to anger and quite merciful.
