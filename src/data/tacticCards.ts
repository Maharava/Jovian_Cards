...
export const TACTIC_CARDS: Card[] = [
  {
    id: 'tactic_power_shot', name: 'Power Shot', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_nano_repair', name: 'Nano-Repair', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_emp_blast', name: 'EMP Blast', type: 'tactic', cost: 3,
  ...
  {
    id: 'tactic_supply_drop', name: 'Supply Drop', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_reinforce', name: 'Reinforce', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_scramble', name: 'Scramble', type: 'tactic', cost: 1,
  ...
  // --- MEGACORP TACTICS ---
  {
    id: 'tactic_asset_seizure', name: 'Asset Seizure', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_outsource', name: 'Outsource', type: 'tactic', cost: 3,
  ...
  {
    id: 'tactic_downsizing', name: 'Downsizing', type: 'tactic', cost: 1,
  ...
  {
    id: 'tactic_hostile_takeover', name: 'Hostile Takeover', type: 'tactic', cost: 5,
  ...
  {
    id: 'tactic_budget_cuts', name: 'Budget Cuts', type: 'tactic', cost: 1,
  ...
  {
    id: 'tactic_rapid_prototyping', name: 'Rapid Prototyping', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_cease_and_desist', name: 'Cease and Desist', type: 'tactic', cost: 3,
  ...
  {
    id: 'tactic_forced_arbitration', name: 'Forced Arbitration', type: 'tactic', cost: 2,
  ...
  {
    id: 'tactic_liquidate_assets', name: 'Liquidate Assets', type: 'tactic', cost: 1,
  ...
  {
    id: 'tactic_market_crash', name: 'Market Crash', type: 'tactic', cost: 4,
