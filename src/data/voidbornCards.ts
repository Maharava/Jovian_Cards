...
// FIXED: Removed 'tier' property to match tierless system used in other factions
export const VOIDBORN_CARDS: Card[] = [
  {
    id: 'enemy_leech', name: 'Void Leech', type: 'unit', cost: 2,
  ...
  {
    id: 'void_voidling', name: 'Voidling', type: 'unit', cost: 1,
  ...
  {
    id: 'void_polyp', name: 'Whispering Polyp', type: 'unit', cost: 2,
  ...
  {
    id: 'void_horror', name: 'Gazing Horror', type: 'unit', cost: 3,
  ...
  {
    id: 'void_tear', name: 'Reality Tear', type: 'unit', cost: 3,
  ...
  {
    id: 'void_flayer', name: 'Mind Flayer', type: 'unit', cost: 4,
